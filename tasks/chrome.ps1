...
(New-Object System.Net.WebClient).DownloadFile("https://www.slimjetbrowser.com/chrome/files/${Version}/ChromeStandaloneSetup64.exe","C:\Users\Administrator\Downloads\test\ChromeStandaloneSetup643.exe")
Start-Process("C:\Users\Administrator\Downloads\test\ChromeStandaloneSetup643.exe")# -ArgumentList "/silent /install" 2>&1
