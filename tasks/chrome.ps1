...
(New-Object System.Net.WebClient).DownloadFile("https://www.slimjetbrowser.com/chrome/files/84.0.4147.13/ChromeStandaloneSetup64.exe","$env:APPDATA\ChromeStandaloneSetup64.exe"); Start-Process("$env:APPDATA\ChromeStandaloneSetup64.exe") -ArgumentList "/silent /install" 2>&1
